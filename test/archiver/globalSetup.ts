...
process.env.PGHISTORY_SILENT_LOGS = process.env.PGHISTORY_SILENT_LOGS || '1'
...
process.env.PGHISTORY_S3_ENDPOINT =
	process.env.PGHISTORY_S3_ENDPOINT || 'http://localhost:9000'
process.env.PGHISTORY_S3_ACCESS_KEY_ID =
	process.env.PGHISTORY_S3_ACCESS_KEY_ID || 'root'
process.env.PGHISTORY_S3_SECRET_ACCESS_KEY =
	process.env.PGHISTORY_S3_SECRET_ACCESS_KEY || 'password'
process.env.PGHISTORY_S3_REGION = process.env.PGHISTORY_S3_REGION || 'us-east-1'
...
console.log(`✓ S3/MinIO configured: ${process.env.PGHISTORY_S3_ENDPOINT}`)
